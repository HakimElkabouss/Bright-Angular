...
var CoursesService = /** @class */ (function () {
    ...
    CoursesService.prototype.getNames = function () {
...
var FavoriteComponent = /** @class */ (function () {
    ...
    FavoriteComponent.prototype.myFavorite = function () {
...
var GithubFollowersComponent = /** @class */ (function () {
    function GithubFollowersComponent(githubFollowersService) {
    ...
    GithubFollowersComponent.prototype.getFollowers = function () {
        var _this = this;
        this.githubFollowersService.getAll()
            .subscribe(function (followers) { return _this.followers = followers; }, function (error) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.Ajouter = function () {
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.getPosts = function () {
        ...
        this.postService.getAll()
            .subscribe(function (posts) { return _this.posts = posts; }, function (error) {
            alert('Erreur inattendue !');
        });
    };
...
var ProfileFollowerComponent = /** @class */ (function () {
    function ProfileFollowerComponent(route) {
        this.route = route;
    }
    ProfileFollowerComponent.prototype.ngOnInit = function () {
    ...
    ProfileFollowerComponent.ctorParameters = function () { return [
    ...
    return ProfileFollowerComponent;
}());
...
var ResumePipe = /** @class */ (function () {
    function ResumePipe() {
    }
    ResumePipe.prototype.transform = function (value, limit) {
        if (!value) {
            return null;
        }
...
var GithubFollowersService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](GithubFollowersService, _super);
    function GithubFollowersService(http) {
        return _super.call(this, 'https://api.github.com/users/HakimElkabouss/followers', http) || this;
    }
...
module.exports = __webpack_require__(/*! C:\Users\Hakim\Desktop\ProjetsSimplon\Angular\BrightCoding-Angular\src\main.ts */"./src/main.ts");
